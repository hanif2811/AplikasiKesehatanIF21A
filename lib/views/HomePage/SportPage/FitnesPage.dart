...
class FitesScreen extends StatefulWidget {
  @override
  _FitesScreenState createState() => _FitesScreenState();
}

class _FitesScreenState extends State<FitesScreen>
    with CountdownMixin<FitesScreen> {
  @override
  void initState() {
    super.initState();
  }
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Image(
                      image: NetworkImage(
                        'https://static.vecteezy.com/system/resources/previews/004/868/452/non_2x/fat-man-runs-on-a-treadmill-fat-guy-runs-on-the-simulator-the-concept-of-losing-weight-and-a-healthy-lifestyle-isolated-vector.jpg',
                      ),
                      width: 500,
                      height: 250,
                    ),
